                    ...
                    <?php
                        $stmtlist = $paging->paginate(); ?> 
                         <div class="card height-auto mt-5">
                            ...
                            <div class="row">
                             <div class="text-secondary h1 mt-3">CHAT</div> 
               ...
               <a  href="index.php?pg=<?php echo md5('dashboard');?>&option=<?php echo md5(''); ?>"
                 ...
                 ><span class="fas fa-times"></span> Close</a>
                    ...
                    <a  href="index.php?pg=<?php echo md5('messages');?>&option=<?php echo md5('add'); ?>"
                     type="" class="btn btn-fill-md text-15 text-light bg-green"><span class="fas fa-plus"></span> Send Message</a>
                                                       </div>
                        ...
                        <div class="mg-b-10 text-center">
                            <div class="row gutters-8">
                                ...
                                <div class="col-3-xxxl col-xl-4 col-lg-4x col-12 form-group">
                                    <input type="text" id="fdsearch" name="fdsearch" value="<?php isset($fdsearch)?$fdsearch:""; ?>"   placeholder="Search by Staff ID" class="form-control" >
                                </div>
                                
                                <div class="col-1-xxxl col-xl-2 col-lg-3 col-12 form-group">
                                <button type="submit" onclick="document.getElementById('viewpage').value='search'; document.myform.submit();" class="fw-btn-fill btn-gradient-yellow">SEARCH</button>
                                ...
                                <div class="col-1-xxxl col-xl-2 col-lg-3 col-12 form-group">
                                    <button type="submit"  onclick="document.getElementById('viewpage').value='reset'; document.getElementById('fdsearch').value=''; document.myform.submit(); " class="fw-btn-fill btn-dark">RESET</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- </form> -->
                            ...
                            <table class="table table-striped text-nowrap">
                                ...
                                <tbody>
                                <?php
                                if($stmtlist_msg->RecordCount() > 0 ){
                                    $num = 1;
                                    while($obj = $stmtlist_msg->FetchNextObject()){
                                     
                                        $objCode = $obj->MESG_CODE;
                                        $keys=$objCode;
                                ?>
                                    <tr style="text-align:center;">
                                    <td><?php echo$num++;?></td>
                                    <td><?php echo  strtoupper($obj->MESG_RECEIVER_NAME);?></td>
                                    <td><?php echo$obj->MESG_SENDER_NAME;?></td>
                                    <td><?php echo$obj->MESG_SUBJECT;?></td>
                                    <td><?php echo$obj->MESG_BODY;?></td>
                                       
                                    <td>
                                        <button type="submit" class="btn btn-fill-md text-15 bg-info text-light "
                                        onclick="document.getElementById('pg').value='<?php echo md5('messgaes');?>'; document.getElementById('option').value='<?php echo md5('details'); ?>'; document.getElementById('viewpage').value='details'; document.getElementById('keys').value='<?php echo $objCode; ?>'; ">
